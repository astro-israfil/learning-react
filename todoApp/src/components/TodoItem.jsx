...
function TodoItem({todo}) {
    ...
    return (
        <>
            <div className="w-full max-w-xl mx-auto flex items-center flex-wrap gap-4">
                <input className="h-4 w-4" type="checkbox" value={todo?.completed} checked={todo?.completed} onChange={() => updateTodo(todo?.id, {...todo, completed: !todo.completed})} />
                {
